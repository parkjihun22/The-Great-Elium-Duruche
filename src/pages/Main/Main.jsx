...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `확장되는 교통 프리미엄`,
    text2: `광역 도로망과 수도권 접근성 강화<br/>
            신안산선(예정) 등 미래 교통망 확장 기대`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `생활 인프라 중심 입지`,
    text2: `중심상업시설 및 생활편의시설 조성 예정<br/>
            배곧·안산 생활권 이용 가능한 입지`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `자연과 함께하는 주거 환경`,
    text2: `단지 인접 수변공원과 녹지축 계획<br/>
            여유로운 일상을 누리는 쾌적한 주거 라이프`,
...
<div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub}>
              브랜드 신뢰 ELIUM{" "}
              <span className={styles.greyText}>프리미엄 주거 가치</span>
            </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  ...
                  - 중심상업시설 및 생활편의시설 조성 예정으로 편리한 생활 환경<br />
                  - 단지 인접 수변공원과 녹지축, 자연이 어우러진 쾌적한 주거 여건<br />
                  - 총 682세대 대단지와 다양한 커뮤니티 시설 구성
                </div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xojnvvje"
              method="POST"
            >
              <label htmlFor="name">
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub1}>
              거모지구의 새로운 시작<br/> 기대되는 미래가치<br/>
              브랜드 신뢰 ELIUM
              <br />
              <span className={styles.greyText1}>프리미엄 주거 가치</span>
              <br />
            </div>
