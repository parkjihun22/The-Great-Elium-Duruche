...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "한시적 특별혜택", subUrl: "/BusinessGuide/plan" },
  ...
  },
  {
    title: "분양안내",
    subMenu: [
      // { subTitle: "옵션계약문안내", subUrl: "/SalesInfo/SubscriptionGuide" },
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "122", subUrl: "/FloorPlan/59B" },
      // { subTitle: "84A", subUrl: "/FloorPlan/84A" },
      // { subTitle: "84B", subUrl: "/FloorPlan/84B" },
      // { subTitle: "98A", subUrl: "/FloorPlan/114A" },
      // { subTitle: "98B", subUrl: "/FloorPlan/114B" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#161b62" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#161b62" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#161b62" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
